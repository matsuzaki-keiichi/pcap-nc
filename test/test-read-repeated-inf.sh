...
OPTSEND='--interval=0.5'
OPTSERV='-l 12345'
OPTCLNT='127.0.0.1 12345 --sleep=1'
OPTRPT='--read-repeated'

echo starting client
$PCAPNC $OPTCLNT $OPTSEND $CHAN $OPTRPT &

echo starting server
$NC $OPTSERV | ../bin/pcap-rmap-target $CHAN --send-data=test-spp.pcap | ../bin/pcap-store --link-type=spw >outdir/test-rmapr-rpl-out-packet-num.pcap
